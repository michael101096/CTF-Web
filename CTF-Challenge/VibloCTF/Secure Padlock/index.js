! function(e) {
    ...
    a.e = function(e) {
        ...
        if (0 !== n)
            ...
            if (n) t.push(n);
                ...
                var r, u = i[e](),
                    c = fetch(a.p + "" + {
                        2: "58c219ce2af76ae7aee8"
                    } [e] + ".module.wasm");
                if (u instanceof Promise && "function" == typeof WebAssembly.compileStreaming) r = Promise.all([WebAssembly.compileStreaming(c), u]).then((function(e) {
                    return WebAssembly.instantiate(e[0], e[1])
                }));
                else if ("function" == typeof WebAssembly.instantiateStreaming) r = WebAssembly.instantiateStreaming(c, u);
                else {
                    r = c.then((function(e) {
    ...
    let r;
    n.e(1).then(n.bind(null, 1)).then(e => {
        r = e;
        let t = document.getElementById("unlock");
        if (!t) throw new Error("Unable to find unlock");
        t.addEventListener("click", e => {
            alert(r.verify(document.getElementById("password").value))
        })
    }).catch(console.error)
}]);